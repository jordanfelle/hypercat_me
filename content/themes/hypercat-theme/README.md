...
[![Minimum Hugo Version](https://img.shields.io/static/v1?label=min-HUGO-version&message=>=v0.156.0&color=blue&logo=hugo)](https://github.com/gohugoio/hugo/releases/tag/v0.156.0)
